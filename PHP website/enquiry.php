...
$selectedProduct = isset($_GET['product']) ? htmlspecialchars($_GET['product']) : '';
$selectedCategory = isset($_GET['category']) ? htmlspecialchars($_GET['category']) : '';
$selectedSize = isset($_GET['size']) ? htmlspecialchars($_GET['size']) : '';
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" id="productCategory" name="productCategory" required>
                                            <option value="" <?php if(empty($selectedCategory)) echo 'selected'; ?> disabled>Select product category...</option>
                                            <option value="ice-cream" <?php if($selectedCategory == 'ice-cream') echo 'selected'; ?>>Ice Creams</option>
                                            <option value="butter-cheese" <?php if($selectedCategory == 'butter-cheese') echo 'selected'; ?>>Butter & Cheese</option>
                                            <option value="milk" <?php if($selectedCategory == 'milk') echo 'selected'; ?>>Milk Products</option>
                                            <option value="beverages" <?php if($selectedCategory == 'beverages') echo 'selected'; ?>>Beverages</option>
                                            <option value="other" <?php if($selectedCategory == 'other') echo 'selected'; ?>>Other</option>
                                        </select>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="productName" name="productName" placeholder="Product name (if known)" value="<?php echo $selectedProduct; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" id="enquiryType" name="enquiryType" required>
                                            <option value="" <?php if(empty($selectedProduct)) echo 'selected'; ?> disabled>Select type of enquiry...</option>
                                            <option value="price" <?php if(!empty($selectedProduct)) echo 'selected'; ?>>Price Inquiry</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="message" name="message" rows="4" placeholder="Please describe your enquiry in detail..." required><?php 
                                        if(!empty($selectedProduct)) {
                                            echo "I'd like to inquire about " . $selectedProduct;
                                            
                                            if(!empty($selectedSize)) {
                                                echo " (Size: " . $selectedSize . ")";
                                            }
                                            
                                            if(!empty($selectedPrice)) {
                                                echo " priced at " . $selectedPrice;
                                            }
                                            
                                            echo ". Please provide information about its availability and any current offers.";
                                        }
                                        ?></textarea>
                                        <div class="invalid-feedback">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            if (!form.checkValidity()) {
                ...
                .then(data => {
                    ...
                    setTimeout(function() {
                        ...
                        // Update success message with green check icon
                        const alertHeading = statusMessage.querySelector('.alert-heading');
                        alertHeading.innerHTML = '<i class="bi bi-check-circle-fill text-success"></i> Enquiry Submitted Successfully!';
        ...
        productCategory.addEventListener('change', function() {
            ...
            updateCategoryIcon(category, iconSpan);
        });
        
        // Update category icon on page load if pre-selected
        if (productCategory.value) {
            updateCategoryIcon(productCategory.value, productCategory.previousElementSibling);
        }
        
        function updateCategoryIcon(category, iconSpan) {
            switch(category) {
                case 'ice-cream':
